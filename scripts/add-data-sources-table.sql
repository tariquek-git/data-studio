...
('fdic_history', 'FDIC History API', 'Official FDIC institution history records for charter openings, mergers, failures, closures, and conversions.', 'US', 'https://api.fdic.gov/banks/history', 'https://api.fdic.gov/banks/history', 'daily', 'active', 'Institution-level events only; branch rows are filtered out before writing charter_events.'),
('fdic_failures', 'FDIC Failures API', 'Official FDIC bank failure records, resolution details, and loss estimates.', 'US', 'https://banks.data.fdic.gov', 'https://banks.data.fdic.gov/api/failures', 'daily', 'active', 'Warehouse-backed failure history persisted independently from the current institutions table.'),
('fdic_enforcement', 'FDIC Enforcement API', 'Official FDIC enforcement action records, civil money penalties, and termination dates.', 'US', 'https://banks.data.fdic.gov', 'https://banks.data.fdic.gov/api/enforcement', 'weekly', 'pending', 'Loader scaffolding exists, but the public FDIC enforcement endpoint needs a re-verified machine-readable path before this source is treated as active.'),
...
('ffiec_cra', 'FFIEC CRA Ratings', 'Community Reinvestment Act public ratings and related disclosure context.', 'US', 'https://www.ffiec.gov', 'https://www.ffiec.gov/craratings/', 'quarterly', 'pending', 'Official CRA ratings loader is wired, but the FFIEC public file may need a manual download when direct scripted fetches are blocked.'),
...
('cfpb_complaints', 'CFPB Consumer Complaint Database', 'Public complaint data covering consumer financial products and institutions.', 'US', 'https://www.consumerfinance.gov', 'https://www.consumerfinance.gov/data-research/consumer-complaints/', 'daily', 'active', 'Complaint-signal layer using company suggestions and official CFPB trend aggregates.'),
