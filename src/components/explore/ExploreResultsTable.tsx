...
function BrimScoreBadge({ score }: { score: number | null }) {
  ...
  // Thresholds must match compute_brim_score() SQL and BRIM_TIERS in registry.ts
  let cls = 'bg-surface-700 text-surface-400 border-surface-600';
  if (score >= 55) cls = 'bg-emerald-50 text-emerald-700 border-emerald-200';
  else if (score >= 40) cls = 'bg-blue-50 text-blue-700 border-blue-200';
  else if (score >= 25) cls = 'bg-amber-50 text-amber-700 border-amber-200';
  else if (score >= 15) cls = 'bg-orange-50 text-orange-700 border-orange-200';
  return (
