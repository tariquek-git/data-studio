...
> Archived 2026-04-12 during Phase 0 standardization. Several claims in this file are stale (agent statuses, branch state, `BRIM_MODE.md` reference to a file that never existed).
